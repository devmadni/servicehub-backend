...
return [
    ...
    'description' => 'AI-powered service orchestration API for Karachi, Pakistan. 6-agent pipeline: intent parsing → provider matching → dynamic pricing → booking simulation → follow-up → dispute resolution.',

    'intro_text' => 'This API powers the ServiceHub mobile app. All /api/v1/* endpoints require a Bearer token from POST /api/auth/login. Quick start: register → login → POST /api/v1/service-requests → GET /api/v1/providers → POST /api/v1/pricing/quote → POST /api/v1/bookings. All bookings are simulated.',
